...
public class InvalidateTokensHandler {
	private final TwitchUserRepository twitchUserRepository;
	private final EventBus eventBus;

	public InvalidateTokensHandler(TwitchUserRepository twitchUserRepository, EventBus eventBus) {
		this.twitchUserRepository = twitchUserRepository;
		this.eventBus = eventBus;
	}

	@GetMapping("/invalidate_tokens")
	public WebResponse invalidateTokens(
		...
		return WebResponse.success("invalidated");
	}
}
